...
//             <DialogDescription>
//               <Label>You have completed the learning material</Label>
//               <div className="flex flex-row gap-3">
//                 <Button onClick={() => navigate("/student-courses")}>
//                   My Learning Materials Page
//                 </Button>
//                 <Button onClick={handleRewatchCourse}>Rewatch Video</Button>
//               </div>
//             </DialogDescription>
//           </DialogHeader>
//         </DialogContent>
        ...
        >
          <Tabs defaultValue="content" className="h-full flex flex-col">
            ...
            <TabsContent value="overview">
              <ScrollArea>
                <div className="p-4">
                  <h2 className="text-xl font-bold mb-4">About this Vdeo</h2>
                  <p className="text-gray-400">
                    {studentCurrentCourseProgress?.courseDetails?.description}
                  </p>
                </div>
